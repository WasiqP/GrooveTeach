...
// Form Icon Options
const FORM_ICONS = [
  { id: 'clipboard', name: 'Clipboard', Icon: ({ size = 28, color = ink.inkSoft }: { size?: number; color?: string }) => (
  ...
  { id: 'star', name: 'Star', Icon: ({ size = 28, color = ink.inkSoft }: { size?: number; color?: string }) => (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
  ...
  { id: 'message', name: 'Message', Icon: ({ size = 28, color = ink.inkSoft }: { size?: number; color?: string }) => (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
  ...
  { id: 'chart', name: 'Chart', Icon: ({ size = 28, color = ink.inkSoft }: { size?: number; color?: string }) => (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
  ...
  { id: 'target', name: 'Target', Icon: ({ size = 28, color = ink.inkSoft }: { size?: number; color?: string }) => (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
  ...
  { id: 'trophy', name: 'Trophy', Icon: ({ size = 28, color = ink.inkSoft }: { size?: number; color?: string }) => (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
                    ...
                    return (
                      ...
                      >
                        <View style={[styles.iconOptionCircle, isSelected && styles.iconOptionCircleSelected]}>
                          <IconComponent size={32} color={isSelected ? '#FFFFFF' : ink.inkSoft} />
                        </View>
