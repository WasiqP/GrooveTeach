...
/** Rounded “door + roof” home — softer than sharp gable outline */
...
/** Mortarboard — reads clearly as “school / classes” */
const ClassIcon = ({ size = 24, color }: { size?: number; color: string }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <Path
      d="M2 10.5 12 5l10 5.5-10 5L2 10.5Z"
      stroke={color}
      strokeWidth={STROKE}
      strokeLinejoin="round"
      strokeLinecap="round"
    />
    <Path
      d="M6 12.5V17c0 1.5 2.5 3 6 3s6-1.5 6-3v-4.5"
      stroke={color}
      strokeWidth={STROKE}
      strokeLinejoin="round"
      strokeLinecap="round"
...
/** Clipboard + list lines — task / to-do vibe */
const QuizIcon = ({ size = 24, color }: { size?: number; color: string }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <Path
...
/** Trophy cup — results / grades */
const GradesIcon = ({ size = 24, color }: { size?: number; color: string }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <Path
      ...
      strokeLinejoin="round"
    />
    <Path d="M8 21h8M12 17v4" stroke={color} strokeWidth={STROKE} strokeLinecap="round" />
  </Svg>
);
...
const BottomTab: React.FC<BottomTabProps> = ({
  ...
  const getIconColor = (routeName: string) =>
    currentRoute === routeName ? theme.primary : ink.iconMuted;
  ...
  const tabContent = (
    <View style={[styles.bottomNav, { paddingBottom }]}>
      ...
      <Pressable
        style={styles.navItem}
        onPress={() => handleNavigate('MyClasses')}
        android_ripple={{ color: theme.rippleLight, borderless: true }}
      >
        <ClassIcon size={24} color={getIconColor('MyClasses')} />
      </Pressable>
      ...
      <Pressable
        ...
        android_ripple={{ color: theme.rippleLight, borderless: true }}
      >
        <QuizIcon size={24} color={getIconColor('Quizzes')} />
      </Pressable>
